...
from . import user_status_pb2 as user__status__pb2
...
class UserStatusStub(object):
    ...
    def __init__(self, channel):
        ...
        self.change = channel.unary_unary(
                ...
                request_serializer=user__status__pb2.UserStatusRequest.SerializeToString,
                response_deserializer=user__status__pb2.UserStatusResponse.FromString,
                )
...
def add_UserStatusServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'change': grpc.unary_unary_rpc_method_handler(
                    servicer.change,
                    request_deserializer=user__status__pb2.UserStatusRequest.FromString,
                    response_serializer=user__status__pb2.UserStatusResponse.SerializeToString,
            ),
    }
...
class UserStatus(object):
    ...
    def change(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/user_status_proto.UserStatus/change',
            user__status__pb2.UserStatusRequest.SerializeToString,
            user__status__pb2.UserStatusResponse.FromString,
...
class MembershipStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMemberships = channel.unary_unary(
                ...
                request_serializer=user__status__pb2.MembershipRequest.SerializeToString,
                response_deserializer=user__status__pb2.ListMembershipResponse.FromString,
                )
        self.Modify = channel.unary_unary(
                '/user_status_proto.Membership/Modify',
                request_serializer=user__status__pb2.MembershipStatusRequest.SerializeToString,
                response_deserializer=user__status__pb2.MembershipStatusResponse.FromString,
                )
        self.GetUserMemberships = channel.unary_unary(
                '/user_status_proto.Membership/GetUserMemberships',
                request_serializer=user__status__pb2.UserMembershipRequest.SerializeToString,
                response_deserializer=user__status__pb2.ListUserMembershipResponse.FromString,
                )
        self.DeleteMemberships = channel.unary_unary(
                '/user_status_proto.Membership/DeleteMemberships',
                request_serializer=user__status__pb2.DeleteMembershipRequest.SerializeToString,
...
def add_MembershipServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetMemberships': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=user__status__pb2.MembershipRequest.FromString,
                    response_serializer=user__status__pb2.ListMembershipResponse.SerializeToString,
            ),
            'Modify': grpc.unary_unary_rpc_method_handler(
                    servicer.Modify,
                    request_deserializer=user__status__pb2.MembershipStatusRequest.FromString,
                    response_serializer=user__status__pb2.MembershipStatusResponse.SerializeToString,
            ),
            'GetUserMemberships': grpc.unary_unary_rpc_method_handler(
                    servicer.GetUserMemberships,
                    request_deserializer=user__status__pb2.UserMembershipRequest.FromString,
                    response_serializer=user__status__pb2.ListUserMembershipResponse.SerializeToString,
            ),
            'DeleteMemberships': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteMemberships,
                    request_deserializer=user__status__pb2.DeleteMembershipRequest.FromString,
...
class Membership(object):
    ...
    def GetMemberships(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/user_status_proto.Membership/GetMemberships',
            user__status__pb2.MembershipRequest.SerializeToString,
            user__status__pb2.ListMembershipResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Modify(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/user_status_proto.Membership/Modify',
            user__status__pb2.MembershipStatusRequest.SerializeToString,
            user__status__pb2.MembershipStatusResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetUserMemberships(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/user_status_proto.Membership/GetUserMemberships',
            user__status__pb2.UserMembershipRequest.SerializeToString,
            user__status__pb2.ListUserMembershipResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DeleteMemberships(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/user_status_proto.Membership/DeleteMemberships',
            user__status__pb2.DeleteMembershipRequest.SerializeToString,
