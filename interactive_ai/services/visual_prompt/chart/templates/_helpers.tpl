...
Common labels
*/}}
{{- define "visual-prompt.labels" -}}
chart: {{ .Chart.Name }}-{{ .Chart.Version | replace "+" "_" }}
{{ include "visual-prompt.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "visual-prompt.selectorLabels" -}}
app: {{ .Chart.Name }}
