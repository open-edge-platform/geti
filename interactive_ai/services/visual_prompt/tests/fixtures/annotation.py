...
from services.rest_views.prediction_rest_views import RestShapeType
...
def fxt_empty_annotation(fxt_empty_detection_label):
    scored_label = ScoredLabel(probability=DummyValues.LABEL_PROBABILITY, label=fxt_empty_detection_label)
