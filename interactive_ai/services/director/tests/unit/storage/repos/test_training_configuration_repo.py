...
class TestTrainingConfigurationRepo:
    def test_get_by_task_id(self, request, fxt_project_identifier, fxt_training_configuration_task_level):
        # Arrange
        ...
        # Act
        retrieved_config = repo.get_by_task_id(fxt_training_configuration_task_level.task_id)
        ...
        assert retrieved_config.global_parameters == fxt_training_configuration_task_level.global_parameters
        assert retrieved_config.hyperparameters == fxt_training_configuration_task_level.hyperparameters
