...
{{ include "director.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "director.selectorLabels" -}}
app: {{ .Chart.Name }}
...
*/}}
{{- define "director.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "director.fullname" .) .Values.serviceAccount.name }}
{{- else }}
