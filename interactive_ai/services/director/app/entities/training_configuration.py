...
from geti_supported_models.hyperparameters import Hyperparameters, DatasetPreparationParameters, AugmentationParameters, \
...
class GlobalDatasetPreparationParameters(BaseModel):
    ...
    filtering: Filtering = Field(
        title="Filtering",
        description="Configuration for filtering annotations"
    )
...
class GlobalParameters(BaseModel):
    ...
    dataset_preparation: GlobalDatasetPreparationParameters = Field(
        ...
        description="Parameters for preparing the dataset"
    )
...
class TrainingConfiguration(BaseModel, PersistentEntity):
    ...
    def __eq__(self, other):
        ...
        # Compare parameters
        if self.global_parameters != other.global_parameters or self.hyperparameters != other.hyperparameters:
            return False
