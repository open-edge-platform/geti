...
class SubsetManagerConfig(ConfigurableParameters):
    ...
    class __SubsetParameters(ParameterGroup):
        ...
        description = string_attribute(
            "Specify the distributions of annotated samples over training, validation and "
            "test set. These values must add up to 1, and will be rescaled if they do not add up correctly."
        )
