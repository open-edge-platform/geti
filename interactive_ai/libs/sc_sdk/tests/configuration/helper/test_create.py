...
from sc_sdk.configuration.helper.config_element_mapping import GroupElementMapping
from sc_sdk.configuration.helper.create import (
...
class TestCreateFunctions:
    ...
    def test_create_default_configurable_enum_from_dict(self):
        ...
        for parameter_dict in [params, DictConfig(content=dict(params))]:
            ...
            assert type(default_value) is SomeEnumSelectable
