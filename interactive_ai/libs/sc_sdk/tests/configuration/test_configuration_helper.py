...
import sc_sdk.configuration.helper as cfg_helper
...
class TestConfigurationHelper:
    ...
    def test_config_reconstruction_with_metadata_change(self):
        ...
        assert reconstructed_config.get_metadata(parameter_name=test_parameter_name)[metadata_key] == new_value
        assert (
            reconstructed_config_from_yaml.get_metadata(parameter_name=test_parameter_name)[metadata_key] == new_value
        )
