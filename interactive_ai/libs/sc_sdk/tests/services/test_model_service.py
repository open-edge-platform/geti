...
class TestModelService:
    ...
    @mock.patch("sc_sdk.services.model_service.ModelStorageRepo")
    @mock.patch("sc_sdk.services.model_service.ModelRepo")
    @mock.patch("sc_sdk.services.model_service.NUM_MODELS_TO_KEEP_IN_STORAGE", 1)
    def test_should_purge_oldest_models_when_storage_limit_exceeded(self, mock_model_repo, fxt_model):
        ...
        mock_purge = mock.patch("sc_sdk.services.model_service.ModelService.purge_model_binaries")
