...
from sc_sdk.repos import AnnotationSceneRepo, AnnotationSceneStateRepo, VideoRepo
...
class TestAnnotationSceneStateHelper:
    def test_compute_annotation_state_local_to_local_unannotated(
        ...
        with patch(
            "sc_sdk.utils.annotation_scene_state_helper.LabelSchemaRepo.get_latest_view_by_task",
