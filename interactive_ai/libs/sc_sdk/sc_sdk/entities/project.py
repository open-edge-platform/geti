...
from sc_sdk.adapters.adapter import IAdapter, ReferenceAdapter
from sc_sdk.entities.dataset_storage import DatasetStorage, NullDatasetStorage
from sc_sdk.entities.task_graph import NullTaskGraph, TaskGraph
...
if TYPE_CHECKING:
    from sc_sdk.entities.interfaces.task_graph_adapter_interface import TaskGraphAdapterInterface
...
class Project(ProjectEntity):
    ...
    >>> from sc_sdk.entities.task_node import TaskType
    ...
    >>> from sc_sdk.adapters.task_graph_adapter import TaskGraphAdapter
