...
from sc_sdk.adapters.adapter import IAdapter
...
class FloatMetadata(IMetadata):
    ...
    def __repr__(self) -> str:
        """Prints the model, data and type of the from sc_sdk.entities.dataset_item."""
...
class VideoMetadata(IMetadata):
    ...
    def __repr__(self) -> str:
        """Prints the video_id, frame_id and type of the from sc_sdk.entities.dataset_item."""
