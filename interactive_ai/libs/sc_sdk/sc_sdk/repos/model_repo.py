...
from sc_sdk.entities.model import Model, ModelFormat, ModelOptimizationType, ModelPrecision, ModelStatus, NullModel
from sc_sdk.entities.model_storage import ModelStorageIdentifier
from sc_sdk.repos.base.model_storage_based_repo import ModelStorageBasedSessionRepo
...
from sc_sdk.repos.mappers.mongodb_mappers.model_mapper import ModelPurgeInfoToMongo, ModelToMongo
...
class ModelRepo(ModelStorageBasedSessionRepo[Model]):
    ...
    def get_latest(
        ...
        *,
        ...
        :return: Latest model entity if any or :class:`~sc_sdk.entities.model.NullModel`
            if not found
        """
    ...
    def get_latest_model_for_inference(
        ...
        :return: The MO model or :class:`~sc_sdk.entities.model.NullModel` if not found
        """
