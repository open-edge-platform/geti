...
from sc_sdk.adapters.model_adapter import DataSource, ExportableCodeAdapter
...
from sc_sdk.entities.model_template import TargetDevice
...
class ModelToMongo(IMapperSimple[Model, dict]):
    ...
    def map_model_backward(instance: dict) -> Model:
        ...
        """
        from sc_sdk.repos import DatasetRepo, ModelRepo, ModelStorageRepo, ProjectRepo
