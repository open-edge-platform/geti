...
from sc_sdk.entities.dataset_entities import NullPipelineDataset, PipelineDataset, TaskDataset
...
from sc_sdk.repos.mappers.mongodb_mappers.dataset_entity_mapper import PipelineDatasetToMongo
...
class PipelineDatasetRepo(DatasetStorageBasedSessionRepo[PipelineDataset]):
    ...
    :class:`~sc_sdk.entities.interfaces.repo_interface.IRepo`, meaning the repository
