...
from iai_core.entities.task_graph import NullTaskGraph, TaskGraph
...
class Project(ProjectEntity):
    ...
    >>> from iai_core.entities.task_node import TaskType
    ...
    >>> from iai_core.adapters.task_graph_adapter import TaskGraphAdapter
    >>> from iai_core.repos.mappers.mongodb_mappers.task_graph_mapper import TaskGraphToMongo
