...
from iai_core.entities.shapes import Ellipse, Keypoint, Point, Polygon, Rectangle, Shape, ShapeType
from iai_core.entities.shapes import ShapeType as SDK_ShapeType
