...
"""
This module implements the repository for code deployment binary files
"""
...
class CodeDeploymentBinaryRepo(BinaryRepo):
    """
    This module implements the repository for code deployment binary files
    """

    object_type = BinaryObjectType.CODE_DEPLOYMENTS
