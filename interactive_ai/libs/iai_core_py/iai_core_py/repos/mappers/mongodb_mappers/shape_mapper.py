...
from iai_core_py.entities.shapes import Ellipse, Keypoint, Point, Polygon, Rectangle, Shape, ShapeType
from iai_core_py.entities.shapes import ShapeType as SDK_ShapeType
