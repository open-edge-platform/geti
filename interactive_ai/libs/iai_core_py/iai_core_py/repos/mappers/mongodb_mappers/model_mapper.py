...
from iai_core_py.adapters.model_adapter import DataSource, ExportableCodeAdapter
...
class ModelToMongo(IMapperSimple[Model, dict]):
    ...
    def map_model_backward(instance: dict) -> Model:
        ...
        """
        from iai_core_py.repos import DatasetRepo, ModelRepo, ModelStorageRepo, ProjectRepo
