...
from iai_core_py.entities.dataset_entities import NullPipelineDataset, PipelineDataset, TaskDataset
...
from iai_core_py.repos.mappers.mongodb_mappers.dataset_entity_mapper import PipelineDatasetToMongo
...
class PipelineDatasetRepo(DatasetStorageBasedSessionRepo[PipelineDataset]):
    ...
    :class:`~iai_core_py.entities.interfaces.repo_interface.IRepo`, meaning the repository
