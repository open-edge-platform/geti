...
from iai_core_py.adapters.adapter import IAdapter
...
class FloatMetadata(IMetadata):
    ...
    def __repr__(self) -> str:
        """Prints the model, data and type of the from iai_core_py.entities.dataset_item."""
...
class VideoMetadata(IMetadata):
    ...
    def __repr__(self) -> str:
        """Prints the video_id, frame_id and type of the from iai_core_py.entities.dataset_item."""
