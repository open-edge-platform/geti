...
class ConfigElementType(Enum):
    ...
    def __new__(cls, value: int, category: ElementCategory):  # noqa: ARG004
    ...
    def __init__(self, value: int, category: ElementCategory):  # noqa: ARG002
    ...
    def category(self) -> ElementCategory:
        ...
        Categories are instances of the `iai_core_py.otx.api.configuration.configuration_types.ElementCategory` Enum.
        """
