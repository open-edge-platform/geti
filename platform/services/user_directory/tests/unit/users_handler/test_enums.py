...
class TestSpiceDBUserRoles:
    ...
    def test_role_from_relation_positive(resource_type: str, relation: str, role_expected: str):
        """
    ...
    def test_role_from_relation_unknown_resource_type(resource_type: str, relation: str):
        """
    ...
    def test_role_from_relation_no_app_role_match(resource_type: str, relation: str):
        """
        Tests the role_from_relation method, negative case.
