...
class EndpointLogger:
    """
    The class contains extend logging of package logger located at: /libs/telemetry_tools
    """
    ...
    def __is_response_object(cls, suspected_object) -> bool:  # noqa: ANN001
        return isinstance(suspected_object, Response) or issubclass(suspected_object.__class__, Response)
    ...
    def __show_request(cls, request_body: dict):
        ...
        for key, value in request_body.items():
            logs_method = cls.__select_logging_method(value)
            logs_method(value)
