...
const getMockedMedia = (name: string, id?: string) => {
    return {
        ...
        annotation_state_per_task: [{ task_id: '6101254defba22ca453f11ce', state: 'to_revisit' }],
...
export const allImages = {
    media: [getMockedMedia('1', 'test-1'), getMockedMedia('2', 'test-2'), getMockedMedia('3', 'test-3')],
    total_images: 3,
    total_matched_images: 1,
    total_matched_video_frames: 0,
    total_matched_videos: 0,
