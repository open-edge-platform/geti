...
export const OPERATION_PERMISSION_NEW: OperationPermission = {
    [OPERATION.ADD_USER_TO_PROJECT]: [WORKSPACE_ADMIN_PERMISSION, PROJECT_ADMIN_PERMISSION],
    ...
    [OPERATION.CAN_SEE_PROJECT]: [PROJECT_ADMIN_PERMISSION, PROJECT_CONTRIBUTOR_PERMISSION],
    ...
    [OPERATION.PROJECT_DELETION]: [WORKSPACE_ADMIN_PERMISSION, PROJECT_ADMIN_PERMISSION],
    [OPERATION.PROJECT_NAME_EDITION]: [WORKSPACE_ADMIN_PERMISSION, PROJECT_ADMIN_PERMISSION],
...
export const OPERATION_PERMISSION_OLD: OperationPermission = {
    [OPERATION.INVITE_USER]: [ORGANIZATION_ADMIN_PERMISSION],
    [OPERATION.MANAGE_USER]: [ORGANIZATION_ADMIN_PERMISSION],
    [OPERATION.WORKSPACE_MANAGEMENT]: [WORKSPACE_ADMIN_PERMISSION],
