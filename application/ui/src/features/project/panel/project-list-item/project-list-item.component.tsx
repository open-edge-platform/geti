...
import { ActiveProjectBadge } from '../../list/active-project-badge/active-project-badge.component';
import { ProjectActionsMenu, type ProjectActionMetadata } from '../../list/menu-actions/menu-actions.component';
import { getProjectTypeTitle } from '../../list/util';
