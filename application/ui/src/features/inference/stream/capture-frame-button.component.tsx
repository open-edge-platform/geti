...
export const CaptureFrameButton = () => {
    ...
    const isStreamConnected: boolean = streamStatus === 'connected';
    ...
    const isSourceProducingFrames = sourceStatus === undefined || sourceStatus === 'ok';

    const isCaptureDisabled =
        !isPipelineRunning || !isStreamConnected || !isSourceProducingFrames || captureFrameMutation.isPending;
