...
export const ModelVariantsTabs = ({ model }: ModelVariantsTabsProps) => {
    ...
    return (
        <Tabs aria-label={t('models.variantsTabsAriaLabel')} UNSAFE_className={classes.tabs}>
            <TabList>
                <Item aria-label={t('models.openvinoTabAria')} key='openvino' textValue='openvino'>
                    <OpenVINO />
                </Item>
                <Item aria-label={t('models.pytorchTabAria')} key='pytorch' textValue='pytorch'>
                    <Pytorch />
                </Item>
                <Item aria-label={t('models.onnxTabAria')} key='onnx' textValue='onnx'>
                    <ONNX />
                </Item>
            </TabList>
