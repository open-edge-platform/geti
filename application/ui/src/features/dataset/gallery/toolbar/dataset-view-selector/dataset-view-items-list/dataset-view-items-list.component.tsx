            ...
            >
                <Flex minWidth={0} alignItems={'center'} justifyContent={'space-between'}>
                    ...
                    <MenuTrigger>
                        <ActionButton
                            isQuiet
                            aria-label={t('dataset.viewActionsAriaLabel', { name: datasetView.name })}
                        >
                            <MoreMenu />
                        </ActionButton>
                        <Menu onAction={handleAction} aria-label={t('dataset.viewActionsMenuAriaLabel')}>
                            <Item key={'rename'}>{t('projectPanel.rename')}</Item>
...
export const DatasetViewItemsList = ({
    ...
    return (
        <ul className={classes.datasetViewsList} aria-label={t('dataset.viewsListAriaLabel')}>
