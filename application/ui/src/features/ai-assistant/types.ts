...
export type AiConnectionMethod = 'api' | 'app';
export type AiAgentId = 'openai-api' | 'openai-app' | 'anthropic-api' | 'anthropic-app';

export interface AiConnection {
    agentId: AiAgentId;
    model: string;
    /** Optional absolute path to a native assistant executable. */
    executable: string;
}
...
export interface AssistantAccount extends CodexAccount {
    type: 'chatgpt' | 'claude';
}
