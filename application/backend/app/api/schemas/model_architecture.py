...
from app.models.model_manifest import Capabilities, License, ModelManifestDeprecationStatus, ModelStats, TimmMetadata
...
class ModelArchitectureView(BaseModel):
    ...
    license: License = Field(title="License", description="License under which the model architecture is released")
